...
export class Skater extends THREE.Group{
    ...
    animate(){
        ...
        timeline.to(this.position,{z:2.6,duration:.6,ease:'linear'})
        timeline.to(this.rotation,{y:-3.15,duration:.05,ease:'linear'})
        timeline.to(this.position,{z:0,duration:.6,ease:'linear'})
        timeline.to(this.rotation,{y:0,duration:.05,ease:'linear'})
        ...
        timeline.to(this.rotation,{y:-3.15,duration:.05,ease:'linear'})
        timeline.to(this.position,{z:-.8,duration:.4,ease:'linear'})
